...
export default function Roulette() {
    useEffect(() => {
        ...
        function setupWheel() {
          ...
          row += "  <div className='card red'>1<\/div>";
          row += "  <div className='card black'>14<\/div>";
          row += "  <div className='card red'>2<\/div>";
          row += "  <div className='card black'>13<\/div>";
          row += "  <div className='card red'>3<\/div>";
          row += "  <div className='card black'>12<\/div>";
          row += "  <div className='card red'>4<\/div>";
          row += "  <div className='card green'>0<\/div>";
          row += "  <div className='card black'>11<\/div>";
          row += "  <div className='card red'>5<\/div>";
          row += "  <div className='card black'>10<\/div>";
          row += "  <div className='card red'>6<\/div>";
          row += "  <div className='card black'>9<\/div>";
          row += "  <div className='card red'>7<\/div>";
          row += "  <div className='card black'>8<\/div>";
          row += "<\/div>";
